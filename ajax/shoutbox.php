...
** File acp_arcade.php 2018-09-22 00:00:00 Thor
**
** CHANGES
**
...
if($op == 'activeusers')
    {
                ...
                if ($db->sql_numrows($res) == 0) $simple .= $user->lang['NO_USERS_ONLINE'];
                    ...
                    $simple .="<br><br><p>".$user->lang['LEGEND_ADMIN']."<img src=\"themes/".$theme."/pics/icon_admin.gif\" alt=\"holder\">".$user->lang['LEGEND_MODERATOR']."<img src=\"themes/".$theme."/pics/icon_moderator.gif\" alt=\"holder\">".$user->lang['LEGEND_PREMIUM']."<img src=\"themes/".$theme."/pics/icon_premium.gif\" alt=\"holder\"> </p><div style='font-size: 8pt;' align=\"center\"><a href=\"javascript:advanced();\">".$user->lang['ADV_ONLINE_MO']."</a></div>";
                        $simple .= "";
                }
            ...
            echo $advanced;
            echo "<br><p>".$user->lang['LEGEND_ADMIN']."<img src=\"themes/".$theme."/pics/icon_admin.gif\" alt=\"holder\">".$user->lang['LEGEND_MODERATOR']."<img src=\"themes/".$theme."/pics/icon_moderator.gif\" alt=\"holder\">".$user->lang['LEGEND_PREMIUM']."<img src=\"themes/".$theme."/pics/icon_premium.gif\" alt=\"holder\"> </p><div style='font-size: 8pt;' align=\"center\"><a href=\"javascript:simple();\">".$user->lang['SEMP_ONLINE_MOD']."</a></div>";
            echo "</div>";
    }
