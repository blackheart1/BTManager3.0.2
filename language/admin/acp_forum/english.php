...
$lang = array_merge($lang, array(
    ...
    'FORUM_CONFexplain'                => 'Here you can Enable/Disable Several Forum Features.<br /><br />',
...
$lang = array_merge($lang, array(
	...
	'YES_POST_MARKINGexplain'		=> 'Indicates whether user has posted to a topic.',
	'YES_READ_MARKING'				=> 'Enable server-side topic marking',
	'YES_READ_MARKINGexplain'		=> 'Stores read/unread status information in the database rather than a cookie.',
	'YES_JUMPBOX'					=> 'Enable display of jumpbox',
	'YES_MODERATORS'				=> 'Enable display of moderators',
	'YES_ONLINE_TRACK'				=> 'Enable display of user online/offline information',
	'YES_ONLINE_TRACKexplain'		=> 'Display online information for user in profiles and topic pages.',
	...
	'SMILIES_LIMITexplain'			=> 'Maximum number of smilies in a post. Set to 0 for unlimited smilies.',
	'HOT_THRESHOLD'					=> 'Popular topic threshold',
	'HOT_THRESHOLDexplain'			=> 'Posts per topic threshold required for the popular topic annotation. Set to 0 to disable popular topics.',
	'MAX_POLL_OPTIONS'				=> 'Maximum number of poll options',
	'MAX_POST_FONT_SIZE'			=> 'Maximum font size per post',
	'MAX_POST_FONT_SIZEexplain'	=> 'Maximum font size allowed in a post. Set to 0 for unlimited font size.',
	'MAX_POST_IMG_HEIGHT'			=> 'Maximum image height per post',
	'MAX_POST_IMG_HEIGHTexplain'	=> 'Maximum height of an image/flash file in postings. Set to 0 for unlimited size.',
	'MAX_POST_IMG_WIDTH'			=> 'Maximum image width per post',
	'MAX_POST_IMG_WIDTHexplain'	=> 'Maximum width of an image/flash file in postings. Set to 0 for unlimited size.',
	'MAX_POST_URLS'					=> 'Maximum links per post',
	'MAX_POST_URLSexplain'			=> 'Maximum number of URLs in a post. Set to 0 for unlimited links.',
	'MIN_CHAR_LIMIT'				=> 'Minimum characters per post/message',
	'MIN_CHAR_LIMITexplain'		=> 'The minimum number of characters the user need to enter within a post/private message. The minimum for this setting is 1.',
	'POSTING'						=> 'Posting',
	'ALLOW_QUICK_REPLY_BUTTON'	=> 'Submit and enable quick reply in all forums',
	'ALLOW_QUICK_REPLY'			=> 'Allow quick reply',
	'ALLOW_QUICK_REPLYexplain'	=> 'This switch allows for the quick reply to be disabled board-wide. When enabled, forum specific settings will be used to determine whether the quick reply is displayed in individual forums.',
	'VISUAL_CONFIRM_POST'					=> 'Enable spambot countermeasures for guest postings',
	'VISUAL_CONFIRM_POSTexplain'			=> 'Requires guest users to pass the anti-spambot task to help prevent automated postings.',
	'POSTS_PER_PAGE'				=> 'Posts per page',
	'TOPICS_PER_PAGE'				=> 'Topics per page',
	'SMILIES_PER_PAGE'				=> 'Smilies per page',
	'CHAR_LIMIT'					=> 'Maximum characters per post/message',
	'CHAR_LIMITexplain'			=> 'The number of characters allowed within a post/private message. Set to 0 for unlimited characters.',
	'QUOTE_DEPTH_LIMIT'				=> 'Maximum nesting depth for quotes',
	'QUOTE_DEPTH_LIMITexplain'		=> 'Maximum quote nesting depth in a post. Set to 0 for unlimited depth.',
));
?>