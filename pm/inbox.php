...
** File inbox.php 2018-09-22 00:00:00 Thor
**
** CHANGES
**
...
$folder_specified = request_var('i', 0);
                ...
                if ($action == 'view_message' && $msg_id)
                {
                    ...
                    $sql = 'SELECT t.*, p.id as msg_id, p.*, u.*
        ...
        view_folder(((isset($id))? $id : '0'), $mode, $folder_id, $folder);
...
echo $template->fetch('pm_inbox.html');
close_out();
