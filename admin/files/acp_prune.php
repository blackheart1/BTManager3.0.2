...
** File files/acp_prune.php 2018-09-22 00:00:00 Thor
**
** CHANGES
**
...
class acp_prune
{
    ...
    */
    ...
    {
        global $db, $db_prefix, $user, $auth, $template, $cache;
        ...
        else
        {
            ...
            {
                $db->sql_freeresult($result);
                trigger_error($sql.$user->lang['NO_FORUM'] . adm_back_link($this->u_action), E_USER_WARNING);
            }
