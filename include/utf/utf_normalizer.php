...
** File utf_normalizer.php 2018-02-18 14:32:00 Black_heart
**
** CHANGES
**
...
class utf_normalizer
{
	...
	*/
	function cleanup(&$str)
	{
		...
		{
			global  $phpEx;
			include('./include/utf/data/utf_nfc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			global  $phpEx;
			include('./include/utf/data/utf_canonical_decomp.' . $phpEx);
		}
	...
	*/
	function nfkc(&$str)
	{
		...
		{
			global  $phpEx;
			include('./include/utf/data/utf_nfkc_qc.' . $phpEx);
		}

		if (!isset($GLOBALS['utf_compatibility_decomp']))
		{
			global  $phpEx;
			include('./include/utf/data/utf_compatibility_decomp.' . $phpEx);
		}
	...
	*/
	function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		{
			global  $phpEx;
			include('./include/utf/data/utf_normalizer_common.' . $phpEx);
		}
		...
		{
			global  $phpEx;
			include('./include/utf/data/utf_canonical_comp.' . $phpEx);
		}
